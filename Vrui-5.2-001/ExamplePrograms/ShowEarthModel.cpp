...
void ShowEarthModel::settingsUpdatedCallback(KoinoniaClient* client,KoinoniaProtocol::ObjectID id,void* userData)
	{
...
ShowEarthModel::ShowEarthModel(int& argc,char**& argv)
	...
	if(client!=0)
		...
		settingsId=koinonia->shareObject("ShowEarthModel.settings",settingsType,settingsTypeId,&settings);
		koinonia->setSharedObjectUpdatedCallback(settingsId,&ShowEarthModel::settingsUpdatedCallback,this);
		}
	#endif
	}
